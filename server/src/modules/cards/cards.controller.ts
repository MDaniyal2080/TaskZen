...
export class CardsController {
    ...
    return this.cardsService.getCalendarCards(
      ...
      boardId,
      {
        ...
        labelIds: labels
          ...
          : undefined,
        completed:
          typeof completed === "string" ? completed === "true" : undefined,
        sortBy,
        sortOrder,
      },
    );
  ...
  addComment(
    ...
    return this.cardsService.addComment(
      id,
  ...
  uploadAttachments(
    ...
    return this.cardsService.uploadAttachments(
      id,
      files,
      req.user.id,
      req.user.role,
  ...
  deleteAttachment(
    ...
    return this.cardsService.deleteAttachment(
      attachmentId,
      req.user.id,
      req.user.role,
    );
  ...
  addLabel(
    ...
    return this.cardsService.addLabel(
      id,
      body.labelId,
      req.user.id,
      req.user.role,
  ...
  removeLabel(
    ...
    return this.cardsService.removeLabel(
      id,
      labelId,
      req.user.id,
      req.user.role,
  ...
  addChecklistItem(
    ...
    return this.cardsService.addChecklistItem(
      id,
      dto.text,
      req.user.id,
      req.user.role,
  ...
  updateChecklistItem(
    ...
    return this.cardsService.updateChecklistItem(
      itemId,
      dto,
      req.user.id,
      req.user.role,
  ...
  deleteChecklistItem(@Param("itemId") itemId: string, @Request() req) {
    return this.cardsService.deleteChecklistItem(
      itemId,
      req.user.id,
      req.user.role,
    );
